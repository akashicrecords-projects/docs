...
## Architecture（架构）
Permit2 由两个合约组成：[`AllowanceTransfer`](https://github.com/akashicrecords-projects/permit2/blob/main/src/AllowanceTransfer.sol) 和 [`SignatureTransfer`](https://github.com/akashicrecords-projects/permit2/blob/main/src/SignatureTransfer.sol)。
